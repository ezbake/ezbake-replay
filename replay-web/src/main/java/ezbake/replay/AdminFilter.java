...
public class AdminFilter implements Filter {
    ...
    public void init(FilterConfig filterConfig) throws ServletException {
        ...
        try {
            ...
            String groupName = EzGroupNamesConstants.APP_GROUP + EzGroupNamesConstants.GROUP_NAME_SEP +
            ...
            currentGroupsMask = groups.getGroupsMask(security.fetchAppToken(ezgroupsSecurityId), Sets.newHashSet(groupName));
